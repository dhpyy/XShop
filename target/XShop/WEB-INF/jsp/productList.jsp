...
<script>
	$(document).ready(function() {
		$(".search button").click(function () {
			window.location.href="product_findByLike?page=1&keyword=" + $(".search input").val()
		})
	})
</script>
</head>
...
<div class="container header">
	<div class="span5">
		<div class="logo">
				<a href="#" target="_blank" class="jd-a" title="叮咚">京东</a>
		</div>
	</div>
	<div class="span9">
		<div class="search">
			<input type="text" value="iphone8预定">
			<button>搜索</button>
		</div>
	</div>
...
<div class="container productList">
		...
		<s:actionmessage/>
			<p style="padding-top:30px"><font style="font-weight:bold; color:#FF0000"><s:actionerror/></p>
